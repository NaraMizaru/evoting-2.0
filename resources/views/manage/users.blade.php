            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <button class="btn btn-danger mr-1"><i class="fa-regular fa-file-export"></i></button>
                        <button data-target="#importUserModal" data-toggle="modal" class="btn btn-warning mr-1"><i class="fa-regular fa-file-import"></i></button>
                    </div>
                </div>
                <div class="card-body">
                            ...
                            @foreach ($user as $item)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('admin.manage.user.delete', $item->id) }}" class="btn btn-danger" data-confirm-delete="true"><i
    ...
    <div class="modal fade" id="addUserModal" tabindex="-1" role="dialog" aria-labelledby="addUserModalLabel"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.manage.user.add') }}" method="POST">
            ...
            <div class="modal-content">
                ...
                <form id="editUserForm" action="" method="POST">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="role">Role</label>
                            <select name="role" id="edit-role-select" class="form-control">
                                <option value="">Pilih Role</option>
                                <option value="siswa">Siswa</option>
                                <option value="guru">Guru</option>
                                <option value="caraka">Caraka</option>
